...
This guide provides in-depth documentation for anyone who want to understand, extend, or customize the Retail AI Location Strategy pipeline.
...
- **Professional Reports**: 7-slide HTML executive presentations
...
flowchart TB
    subgraph Input
        U[/"User: I want to open a coffee shop in Jersey City, New Jersey"/]
    end
...
Creates a 7-slide HTML presentation.
